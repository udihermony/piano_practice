/**
 * A minimal MusicXML sample for Phase 1: a one-octave C major scale followed by
 * a C major triad. Used to prove OSMD rendering + cursor stepping + expected-MIDI
